...
namespace Evento.Core.Domain
{
    public class Event : Entity
    {
        ...
        public void SetDates(DateTime startDate, DateTime endDate)
        {
            ...
            {
                throw new Exception($"Event with id: {Id} must have a end date greater t han start date.");
            }
            StartDate = startDate;
            EndDate = endDate;
        }
        ...
        public void PurchaseTickets(User user, int amount)
        {
            ...
            {
                throw new Exception($"Not enough avaiable tickets to purchase ({amount}) by user: '{user.Name}'.");
            }
        ...
        public void CancelPurchasedTickets(User user, int amount)
        {
            ...
            {
                throw new Exception($"ot enough purchased tickets to be canceled({amount}) by user: '{user.Name}'.");
            }
